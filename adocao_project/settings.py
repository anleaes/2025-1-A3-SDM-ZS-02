"""
Django settings for adocao_project project.
...
#SECRET_KEY = 'django-insecure-w7q!hpk&lkgo^wn!!=@45krp*49%9^5(*cbd0nh(pu4)nznbt1'
...
WSGI_APPLICATION = 'adocao_project.wsgi.application'
...
# Configurações para armazenamento de mídia (imagens)
MEDIA_URL = '/media/'
